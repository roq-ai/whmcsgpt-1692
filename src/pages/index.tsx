...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`WhmcsGPT`}</title>

        <meta
          name="description"
          content="Experience seamless customer service with WhmcsGPT - Your trusted partner for efficient ticket responses using advanced ChatGPT integration."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless customer service with WhmcsGPT - Your trusted partner for efficient ticket responses using advanced ChatGPT integration.`}
            </Text>
            <Box
